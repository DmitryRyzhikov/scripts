...
function createFaces() {
    // offsets
    var artboardXOffset = 150;
    var artboardYOffset = -100;

    var pictureXOffset = 500;
    ...
    for (var x = 0; x < 3; x++) {
        for (var y = 0; y < 4; y++) {
            ...
            if (group) {
                ...
                var hairColorNumber = getRandomInt(1, 17);
                ...
                var lipsGroupNumber = getRandomInt(17, 18);
                ...
                var hairGroupNumber = getRandomInt(1 , 4);
                var hairCopyGroup = copyGroupAndAlignItToFacePin(hairGroupName + hairGroupNumber, topPinCenterPosition);
                // recolor hair
                recolorColorObjectsInGroup(hairCopyGroup, colorPath, hairColorOne);
